...
@WithMockUser
@EmbeddedKafka
class EmployeeCloudProjectKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/employee-cloud-project-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/employee-cloud-project-kafka/consume")
